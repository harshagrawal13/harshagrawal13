...
\marginpar{
    ...
    \raggedright{
        ...
        \cvevent{JESPR - Energy Based Modelling for Proteins}{}{  May 2023 - December 2023}{}
        \begin{itemize}
            ...
            \item Currently evaluating zero-shot performance on protein function benchmarks such as solubility, stability, etc. (from \href{https://arxiv.org/abs/2206.02096}{arxiv.org/abs/2206.02096}).
            \item Code: \href{https://github.com/atom-51/jespr}{github.com/atom-51/jespr}
        \end{itemize}

        \divider

        \cvevent{Cancer-eX - Detecting Pancreatic Cancer early}{}{Aug 2018 - August 2021}{}
        \begin{itemize}
...
\begin{itemize}
    \item {Preprint: J. Lala, H. Agrawal, F. Dong, J. Wells, S. Angioletti-Uberti. \textit{An Energy Landscape Approach to Miniaturizing Enzymes using Protein Language Model Embeddings}. bioRxiv, March 2026. \href{https://doi.org/10.64898/2026.03.04.709378}{doi:10.64898/2026.03.04.709378}}
...
\begin{itemize}
    \item {Engineered novel, nanomolar-affinity binders for \textit{C. elegans} transmembrane receptors by re-purposing large protein toxins and designing new target-specific affinities. (\textit{In collaboration with} \href{https://lms.mrc.ac.uk/research-group/synthetic-biology/}{Dr. Karen Sarkisyan} \textit{and} \href{https://tierpsy.com/andre}{Andre Brown}.)}
